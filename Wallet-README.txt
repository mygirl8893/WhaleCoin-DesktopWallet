...
The WhaleCoin wallet, which allows you to create simple and multisig wallets to manage your ether.
...
On OSX its `~/Library/WhaleCoin/gwhale.ipc` on linux `~/.whalecoin/gwhale.ipc` and on windows it uses a named pipe, which doesn't need to be renamed.

Example:

    $ gwhale --datadir /my/chain/ --networkid 23 --ipcpath ~/Library/WhaleCoin/gwhale.ipc
...
- Mac: ~/Library/WhaleCoin
- Windows: %APPDATA%\Roaming\WhaleCoin
- Linux: ~/.whalecoin
...
https://github.com/WhaleCoinOrg/meteor-dapp-wallet/issues
...
https://github.com/WhaleCoinOrg/meteor-dapp-wallet

And the binary application code, which wraps the wallet app can be found at   
https://github.com/WhaleCoinOrg/mist/tree/wallet
...
https://github.com/WhaleCoinOrg/mist/tree/wallet#deployment
